...
add_fileset_file TERASIC_DC_MOTOR_PWM.v VERILOG PATH TERASIC_DC_MOTOR_PWM.v TOP_LEVEL_FILE
...
add_interface_port conduit_end_1 PWM pwm Output 1
add_interface_port conduit_end_1 DC_MOTOR_IN1 motor_in1 Output 1
add_interface_port conduit_end_1 DC_MOTOR_IN2 motor_in2 Output 1
